...
from old_files import baseline_deletion


airport_dc = Path("/DCandDelset/dc_configs/raw_constraints/topAirportDCs")
hospital_dc = Path("/DCandDelset/dc_configs/raw_constraints/topHospitalDCs")
ncvoter_dc = Path("/DCandDelset/dc_configs/raw_constraints/topNCVoterDCs")
tax_dc = Path("/DCandDelset/dc_configs/raw_constraints/topTaxDCs")
